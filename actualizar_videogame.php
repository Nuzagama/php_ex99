...
<body>
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST") {
        $videojuego_name = $_POST['actualizar'];
        $titulo = $_POST["titulo"];
        $distribuidora = $_POST["distribuidora"];
        $precio = (double) $_POST["precio"];
        // Fase de Preparación (Prepare)
        $sql = $conexion -> prepare("UPDATE videojuegos SET (?, ?, ?)");
    ...
    <div class="container">
        ...
        <form action="" method="POST">
            <div class="mb-3">
                ...
                <input class="form-control" type="text" name="titulo" placeholder=<?php $videojuego_name ?>>
            </div>
            <div class="mb-3">
